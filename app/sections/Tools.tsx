...
SiNeovim, SiNextdotjs, SiReact, SiRust, SiTypescript, SiWebstorm,
SiZig,SiBlender,SiVuedotjs,SiTailwindcss,SiPython,SiFlask,SiDjango,SiUnity,SiAtlassian,SiAdobepremierepro,SiPhp
...
<section
    ...
    <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        <AnimatedTitle text={"TOOLS IM USING."}
            ...
            } wordSpace={"mr-[14px]"} charSpace={"mr-[0.001em]"} />

        <div className="mx-auto w-[100%] lg:max-w-[1200px] justify-center">
            <div
                className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-bold leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[40px] md:leading-relaxed lg:mb-16 lg:w-[50%]">
